...
By looking at the code from Git Hub, we see that the code needs to change is in line 43, so we type <43j> to move the cursor down 43 lines from what line you are, and now we are in line 1. In line 43, the line writes `index1 += 1`,
